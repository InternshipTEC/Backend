...
export class initialize1629726960639 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(255) NOT NULL, `nim` varchar(255) NOT NULL, `verified` tinyint NOT NULL DEFAULT 0, `name` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `transaction_id` varchar(36) NULL, UNIQUE INDEX `IDX_64300667e061229048bd6bbcef` (`nim`, `email`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
