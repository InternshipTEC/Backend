...
@Index(
  "service_provider_area_UNIQUE",
  ["serviceProviderIdServiceProviderAvailabilityAreaId"],
  { unique: true }
)
@Index(
  "fk_service_provider_availability_area_service_provider_id_idx",
  ["serviceProviderId"],
  {}
)
...
export class ServiceProviderAvailabilityArea {
  ...
  @JoinColumn([
    { name: "service_provider_id", referencedColumnName: "serviceProviderId" },
  ])
