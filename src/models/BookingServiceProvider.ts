...
@Index(
  "fk_booking_service_provider_service_id",
...
export class BookingServiceProvider {
  ...
  @ManyToOne(() => Booking, (booking) => booking.bookingServiceProviders, {
    onDelete: "CASCADE",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => Role, (role) => role.bookingServiceProviders, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(
    ...
    (serviceProviderServices) =>
      serviceProviderServices.bookingServiceProviders,
  ...
  @ManyToOne(() => User, (user) => user.bookingServiceProviders, {
    onDelete: "CASCADE",
    onUpdate: "NO ACTION",
  })
