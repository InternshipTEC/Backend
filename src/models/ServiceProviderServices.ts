...
@Index('fk_service_provider_service_role_id_idx', ['serviceProviderServiceRoleId'], {})
...
export class ServiceProviderServices {
  ...
  @OneToMany(
    ...
    serviceProviderRoleServices => serviceProviderRoleServices.serviceProviderRoleService,
  )
  serviceProviderRoleServices: ServiceProviderRoleServices[]

  @ManyToOne(
    () => Role,
    role => role.serviceProviderServices,
    {
      onDelete: 'NO ACTION',
      onUpdate: 'NO ACTION',
    },
