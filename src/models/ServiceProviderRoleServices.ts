...
@Index(
  "service_provider_role_service_UNIQUE",
  ["serviceProviderRoleIdServiceProviderRoleServiceId"],
  { unique: true }
)
@Index("fk_service_provider_role_id_idx", ["serviceProviderRoleId"], {})
@Index(
  "fk_service_provider_role_service_id_idx",
  ["serviceProviderRoleServiceId"],
  {}
)
...
export class ServiceProviderRoleServices {
  ...
  @ManyToOne(
    ...
    (serviceProviderServices) =>
      serviceProviderServices.serviceProviderRoleServices,
    { onDelete: "CASCADE", onUpdate: "CASCADE" }
  )
  @JoinColumn([
    {
